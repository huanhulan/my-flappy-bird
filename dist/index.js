...
/******/ 	__webpack_require__.p = "https://huanhulan.github.io/my-flappy-bird/dist/";
/******/
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Bird__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Sky__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Pipe__ = __webpack_require__(4);




var Fly = {};
Fly.Bird = __WEBPACK_IMPORTED_MODULE_0__Bird__["a" /* default */];
Fly.Sky = __WEBPACK_IMPORTED_MODULE_1__Sky__["a" /* default */];
Fly.Pipe = __WEBPACK_IMPORTED_MODULE_2__Pipe__["a" /* default */];
...
Fly.loadImages = function(imgsSrcArr, callback) {
    ...
    imgsSrcArr.forEach(function(imgSrc) {
        var img = new Image();
        img.src = "https://huanhulan.github.io/my-flappy-bird/src/" + imgSrc + ".png";
...
module.exports = function() {
	return new Worker(__webpack_require__.p + "f27b4352f6903109ad2c.worker.js");
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Fly__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_style_css__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_worker_loader_scoreWorker__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_worker_loader_scoreWorker___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_worker_loader_scoreWorker__);
...
class Game {
    ...
    start() {
        var self = this;
        __WEBPACK_IMPORTED_MODULE_0__Fly__["a" /* default */].loadImages(self.imgsArr, function(imgList) {
            self.isRuing = true;
    ...
    initRoles(imgList) {
        ...
        for (let i = 0; i < totalSkyNo; i++) {
            var sky = new __WEBPACK_IMPORTED_MODULE_0__Fly__["a" /* default */].Sky({
                ctx: this.ctx,
                img: skyImg,
                x: i * skyImg.width,
        ...
        for (let i = 0; i < totalPipeNo; i++) {
            let pipe = new __WEBPACK_IMPORTED_MODULE_0__Fly__["a" /* default */].Pipe({
                ctx: this.ctx,
                imgUp: pipeUpImg,
                imgDown: pipeDownImg,
        ...
        // draw bird
        var bird = new __WEBPACK_IMPORTED_MODULE_0__Fly__["a" /* default */].Bird({
            ctx: this.ctx,
            img: imgList["birds"]
        });
...
window.onload = function() {
    var scoreWorker = new __WEBPACK_IMPORTED_MODULE_2_worker_loader_scoreWorker___default.a;
